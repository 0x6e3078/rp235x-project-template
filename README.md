...
This template is intended as a starting point for developing your own firmware based on the rp235x-hal, current blinky demo runs on the Pimoroni Pico Plus 2. Its based on the https://github.com/rp-rs/rp2040-project-template.git project and the https://github.com/embassy-rs/embassy.git.
...
* **Loading a UF2 over USB**
  ...
  *Step 4* - Use `cargo run`, which will compile the code and start the
  ...
  file and copy it to your RP235x.
...
<details open="open">
  ...
  ```
  rp235x-hal = { version="0.10", features=["rt", "critical-section-impl", "rom-v2-intrinsics"] }
  ```
</details>
...
7. I will review the Pull Request and discuss any changes that may be required.
